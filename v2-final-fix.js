(() => {
  ...
  const ports = {
    ...
    jinudo: { x: 420, y: 220, name: '진우도 관찰지점' }
  };
  ...
  const pairRoutes = {
    'dadaepo-gadeok': [
      [645,190],[648,245],[640,310],[610,370],[560,420],[515,440],[430,500],
    ...
    'dadaepo-jinudo': [
      [645,190],[648,245],[640,310],[610,370],[550,420],[480,400],[435,325],[420,220]
    ],
    'gadeok-noksado': [
    ...
    'gadeok-jinudo': [
      ...
      [320,480],[350,420],[390,320],[420,220]
    ],
    'jinudo-noksado': [
      [420,220],[410,265],[415,290],[425,305]
    ]
  };
  const slowPairRoutes = {
    'dadaepo-gadeok': [
      [645,190],[648,245],[640,310],[610,370],[560,420],
      [430,430],[340,450],[250,470],[165,500],[83,500]
    ],
    'dadaepo-noksado': [
      [645,190],[648,245],[640,310],[610,370],[540,400],[470,365],[425,305]
    ],
    'dadaepo-jinudo': [
      [645,190],[648,245],[640,310],[610,370],[540,400],[475,345],[420,220]
    ],
    'gadeok-noksado': [
      [83,500],[150,500],[240,470],[330,440],[400,390],[425,305]
    ],
    'gadeok-jinudo': [
      [83,500],[150,500],[220,480],[300,430],[370,330],[420,220]
    ],
    'jinudo-noksado': [
      [420,220],[418,275],[425,305]
    ]
  };
